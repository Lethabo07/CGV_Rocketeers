...
export const stageOneButton = document.getElementById('stageOne')!;
export const stageTwoButton = document.getElementById('stageTwo')!;
export const stageThreeButton = document.getElementById('stageThree')!;

export const startPanel = document.getElementById('levelStartPanel')!;
export const stagesPanel = document.getElementById('stages')!;
