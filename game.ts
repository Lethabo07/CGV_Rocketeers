...
import {
    ...
    showLevelEndScreen,
    startGameButton,
    startPanel, stagesPanel,
    stageOneButton, stageTwoButton, stageThreeButton,
    uiInit,
    updateLevelEndUI
} from './game/ui';
import {
...
//Initialise an a cloudparticle array
let cloudParticles = [];
...
const animate = () => {
    ...
    if (sceneConfiguration.rocketMoving) {
        ...
        sceneConfiguration.speed += 0.005;
        sceneConfiguration.courseProgress += sceneConfiguration.speed - 5;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////////////////////
    stageThreeButton.onclick = (event) => {
        // Indicate that the animation from the camera starting position to the rocket location is running
        sceneConfiguration.cameraStartAnimationPlaying = true;
        // Remove the red text on the shield item, if it existed from the last level
        shieldUiElement.classList.remove('danger');
